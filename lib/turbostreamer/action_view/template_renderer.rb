...
class TurboStreamer
  module ActionView
    # Prepended to ::ActionView::TemplateRenderer by the railtie.
    #
    ...
    module TemplateRenderer
      ...
      private
        ...
        # ActionView renders the template into a string first and then hands
        # that string to the layout. That works for ERB, where the layout
        # concatenates text.
        #
